...
var MAKEAPI_ORIGIN = 'https://makeapi.webmaker.org';
var ORIGIN;
...
if (process.env.MAKEAPI_ORIGIN) {
  MAKEAPI_ORIGIN = process.env.MAKEAPI_ORIGIN;
}
...
exports.MAKEAPI_ORIGIN = MAKEAPI_ORIGIN;
