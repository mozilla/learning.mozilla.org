...
_.extend(TeachAPI.prototype, {
  ...
  startOAuth2Logout: function(path) {
    path = path || window.location.pathname;
    var callback = window.location.protocol + '//' +
                   window.location.host + path;
    var url = this.baseURL + '/auth/oauth2/logout?callback=' +
              encodeURIComponent(callback);
    window.location = url;
  },
  startOAuth2Login: function(path, action) {
    action = action || 'signin';
    path = path || window.location.pathname;
    var callback = window.location.protocol + '//' +
                   window.location.host + path;
    var url = this.baseURL + '/auth/oauth2/authorize?callback=' +
              encodeURIComponent(callback) + '&action=' + action;
    window.location = url;
  },
  startOAuth2StatusCheck: function() {
