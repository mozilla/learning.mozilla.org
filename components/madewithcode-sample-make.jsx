      ...
      <div className="madewithcode-sample-make">
        ...
        <div className="details-section">
          ...
          <div className="btn-section">
            <a className="remix-btn" href={this.props.remixUrl}><i className="fa fa-code-fork"></i>Remix</a>
            <a className="details-btn btn-info" href={this.props.detailsUrl}>Details</a>
          </div>
        </div>
      </div>
    );
