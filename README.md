...
`NEWSLETTER_MAILINGLIST_URL` | is the newsletter signup form URL generated by BSD. If undefined, newsletter signup is simulated for development purposes.
`NEWSLETTER_MAILINGLIST_PRIVACY_NAME` | is the `name` attribute of the privacy policy checkbox on the newsletter signup form generated by BSD.
