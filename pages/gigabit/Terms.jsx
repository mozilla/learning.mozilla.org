        ...
        <article>
          ...
          <section className="terms-section">
            ...
            <ol>
              ...
              <li>Does the project leverage gigabit technologies such as virtual reality, 4K video, artificial intelligence, and their related curricula.</li>
            </ol>
            <p>
            ...
            <h5>Working Open</h5>
            <ol>
              <li>Does the project include the participation of the target population in developing and executing the project?</li>
              <li>Does the proposal include a plan to share methods, progress and results in a transparent, easily accessible manner?</li>
            </ol>
            <h5>Spread, Scale, and Sustainability</h5>
            <ol>
              <li>Is there a plan to sustain the benefits of this work beyond the project period?</li>
              <li>Can the work be spread and scaled to other organizations and to other communities?</li>
            </ol>
            <h5>Project Team</h5>
            <ol>
          ...
          <section className="terms-section">
            ...
            <p>
            The grants awarded for each round of the Fund will be posted on the Mozilla Gigabit <a href="/gigabit">website</a> when the awards are made.
            </p>
          </section>
        </article>
