      ...
      <div>
        ...
        <div className="m-b-3 clearfix">
          ...
          <div className="col-xs-10 col-xs-offset-1">
            <ol className="circled-ol">
              <li><span>Review the Gigabit Community Fund’s <a href="/gigabit/apply/terms">Terms and Conditions</a> and <a href="https://mzl.la/GCF_FAQ">frequently asked questions</a>. You can also check out some sample applications that have previously received funding, <a href="https://drive.google.com/file/d/0B1Tu07mQk89LRmpfWXlHNmhmQk0/view?usp=sharing" target="_blank">here</a> and <a href="https://drive.google.com/file/d/0B1Tu07mQk89LMGtaY3RYUHRxTWs/view?usp=sharing" target="_blank">here</a>. (Please note that proposal format and questions have been updated.)</span></li>
              <li><span>Visit our grant management system, <a href="https://mozilla.fluxx.io" target="_blank">Fluxx</a>, and sign in or create an account. Submit a Letter of Intent by December 1, 2017. Please refer to <a href="https://docs.google.com/document/d/1HYUgM4BGtb85ZbrDRT-DxJcKCo5QOfgA_gWIC0hjnA8/edit?usp=sharing" target="_blank">the Fluxx guide</a> for more information. Successful LOI submissions will receive an email invitation to submit a full proposal.</span></li>
              ...
              <li><span>Submit a full application to the Gigabit Community Fund on <a href="https://mozilla.fluxx.io/user_sessions/new" target="_blank">the Fluxx application system</a> on or before January 19, 2018.</span></li>
            </ol>
          </div>
        </div>
