    ...
    return (
        <div className="inner-container call-container">
          ...
          <section className="callout-box past-workshop">
            <h2>Past Workshop</h2>
            <p className="date">May 11 - 7am PT, 10am ET, 2pm UTC</p>
          ...
          <div className="video-wrapper">
            <iframe className="workshop-video" width="560" height="315" src="https://air.mozilla.org/mozilla-curriculum-workshop-spring-2017/video" frameBorder="0" allowFullScreen></iframe>
          </div>
