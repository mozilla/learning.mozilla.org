  ...
  render: function() {
    ...
    return (
      <li>
        ...
        <p><span className="club-location" onClick={this.handleLocationClick}><span className="fa fa-map-marker"/> {club.location.split(',')[0]}</span></p>
