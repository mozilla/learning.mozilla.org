...
var PledgeSignupForm = React.createClass({
  ...
  render: function() {
    ...
    return (
      <form className="mailinglist-signup center-block" action={process.env.PLEDGE_MAILINGLIST_URL} method="POST" onSubmit={this.handleSubmit}>
        <fieldset>
...
var HomePage = React.createClass({
  statics: {
    pageClassName: 'home-page home-page4',
    ...
    return (
      <div>
        <HeroUnit>
          ...
          <div className="pledge-cta-container-4 center-block">
            <ImageTag 
