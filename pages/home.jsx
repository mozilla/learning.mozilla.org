    ...
    return (
      <div className="case-studies">
        <Blockquote className="primary-quote" author="Maurya C. New York, United States"
            imgSrc="/img/home-page/maurya-nyc.png" imgSrc2x="/img/home-page/maurya-nyc@2x.png" imgAlt="Maurya NYC Quote">
...
var HomePage = React.createClass({
  render: function() {
    return (
      <div>
        <HeroUnit image="/img/home-page/hero-unit.png"
                  image2x="/img/home-page/hero-unit@2x.png">
        ...
        <div className="inner-container">
          <div className="values">
            ...
            src1x="/img/home-page/values.jpg" src2x="/img/home-page/values.jpg"
