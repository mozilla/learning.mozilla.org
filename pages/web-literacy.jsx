...
var WebMapItem = React.createClass({
  ...
  render: function() {
    var classList = "web-map-item-container";
        ...
        <section>
          ...
          <WebMaps>
            ...
            <WebMap head="Build" subhead="Writing the Web">
              ...
              <WebMapItem head="coding/scripting">
            ...
            <WebMap head="Connect" subhead="Participating on the Web">
              ...
              <WebMapItem head="open practices">
