...
var SectionList = React.createClass({
  ...
  sectionList: function() {
    ...
    var become_a_fellow_message = formatMessage({id: 'become_a_fellow_message'}, {developerNetworkLink: developerNetworkLink, scienceLink: scienceLink, advocacyLink: advocacyLink, newsLink: newsLink});
    return [
        {
